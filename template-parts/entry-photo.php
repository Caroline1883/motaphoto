<section class="singlephoto">
  ...
  <div class="photonav">
    ...
    <?php } else { ?>
    <a class="navright inactive" href="<?php echo esc_url($next_post_url); ?>"><img src="<?php echo esc_url(get_template_directory_uri()) . '/assets/img/next.svg'; ?>" alt="Navigation droite"></a>
    <?php } ?>
